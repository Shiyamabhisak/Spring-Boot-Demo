...
* The original package name 'com.example.springboot-jooq-employee-crud' is invalid and this project uses 'com.example.springboot_jooq_employee_crud' instead.
...
* [JOOQ Access Layer](https://docs.spring.io/spring-boot/3.4.5/reference/data/sql.html#data.sql.jooq)
